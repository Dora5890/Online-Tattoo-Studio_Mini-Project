...
# echo "<script>" . "window.location.href='./homeindex'" . "</script>";
 # exit;
#}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  if (empty(trim($_POST["user_login"]))) {
    $user_login_err = "Please enter your usernlocalhostame or an email id.";
  } else {
        ...
        if (mysqli_stmt_num_rows($stmt) == 1) {
          ...
          if (mysqli_stmt_fetch($stmt)) {
            ...
            if (password_verify($user_password, $hashed_password)) {
              ...
              echo "<script>" . "window.location.href='homeindex.php'" . "</script>";
              exit;
            } else {
