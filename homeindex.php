...
<body>
      ...
      <button onclick="topFunction()" id="myBtn" title="Go to top">Top</button>
        ...
        <div id="home" class="home">
            ...
            <div class="col-r">
                ...
                <div class="btn-h">
                   <a href=" https://wa.me/+919704612806" target="_balnk"> Book An Appoinment</a>
                </div>
            </div>
            <div class="col">
                
                <div class="">
		<h1 style="font-size:500%;color:yellow;text-align:center;">Welcome  <?php echo $_SESSION["username"] ?> </h1>
        ...
        <div id="images" class="images">
            ...
            <div class="img-slider">
                ...
                <div class="slide">
                  <img src="./images/arm band.jpg" width= "1000px"
                  height= "600px"alt="">
                  <div class="info">
                    <!-- <h2>Slide 05</h2> -->
                    <!-- <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p> -->
        ...
        <div class="videos">
          ...
          <video src="videos/v3.mp4" muted></video>
                      ...
                      <div class="icons">
                          ...
                          <div class="row">
                              ...
                              <div class="info">
                                  ...
                                  <div class="sub-title">dasaridorababu@gmail.com</div>
                              </div>
                          </div>
                          <div class="row">
    ...
    <footer>
      <span>Created By <a href="#">DORABABU</a> | <span class="far fa-copyright"></span> 2021 All rights reserved.</span>
    </footer>
